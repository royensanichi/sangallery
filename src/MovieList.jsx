...
export default function MovieList() {
  ...
  //pressing esc button will close modal
  useEffect(() => {
    ...
    return (
      <nav aria-label="Page navigation">
        <ul className="inline-flex -space-x-px text-sm">
          <li>
            <a
              className={`flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 ${
                page === 1
  ...
  return (
    <div className="justify-center mx-auto">
      ...
      <div className="justify-center bg-gradient-to-b from-blue-500">
        <div className="mx-auto min-h-800 p-2 sm:p-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-screen-xl">
            ...
            state.posts.map((data, index) => {
              return (
                ...
                >
                  ...
                  <img
                    className={`rounded-t-lg w-full object-contain ease-in duration 300`}
                  ...
                  <div className="flex flex-col items-center text-center p-4 space-y-2">
                    ...
                    <p className="hover:text-red-100 font-normal text-gray-700 dark:text-gray-400">
                      {shortdesc(data)}
                    </p>
                  </div>
                  {/* Hover overlay */}
                  <div className="cursor-pointer absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <button
                      className="cursor-pointer disabled text-white text-lg font-semibold"
                      onClick={() => openModal(data)}
                    >
                      Read more
                    </button>
        ...
        {state.modalOpen && (
          ...
          >
            <div
              className="bg-gray-600 hover:bg-gray-700 opacity-100 p-6 rounded-lg shadow-lg max-w-lg w-full relative duration-300"
            ...
            >
              ...
              <img
                ...
                className={`mx-auto object-contain bg-black p-4 transition-opacity ease-in duration-1000 ${
